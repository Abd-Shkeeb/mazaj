...
export default function AnalyticsTab({
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200">
      ...
      <div className="flex bg-stone-100/80 p-1 rounded-xl border border-stone-200/80 gap-1 w-full max-w-2xl mx-auto sm:mx-0 overflow-x-auto scrollbar-none">
        {[
          ...
          <button
            ...
            className={`flex-1 text-center py-2 px-3 rounded-lg text-xs font-bold transition-all cursor-pointer whitespace-nowrap ${
      ...
      {activeAnalyticsSubTab === 'kiosk' && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 animate-in fade-in duration-250">
          <div className="bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm flex flex-col justify-between h-36">
            <div className="flex justify-between items-start">
              ...
              <div className="p-2.5 bg-amber-50 text-amber-700 rounded-xl border border-amber-200/40">
          ...
          <div className="bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm flex flex-col justify-between h-36">
            <div className="flex justify-between items-start">
              ...
              <div className="p-2.5 bg-purple-50 text-purple-700 rounded-xl border border-purple-200/40">
          ...
          <div className="bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm flex flex-col justify-between h-36">
            <div className="flex justify-between items-start">
              ...
              <div className="p-2.5 bg-stone-100 text-stone-850 rounded-xl border border-stone-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 animate-in fade-in duration-250">
            <div className="bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm flex flex-col justify-between h-36">
              <div className="flex justify-between items-start">
                ...
                <div className="p-2.5 bg-emerald-50 text-emerald-700 rounded-xl border border-emerald-200/40">
        ...
        (!limits.hasSalesReports ? (
          ...
          <div className="space-y-6 animate-in fade-in duration-250">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm space-y-4">
                ...
                <div className="relative h-48 w-full pt-4">
                  ...
                  >
                    ...
                    <line x1="50" y1="20" x2="650" y2="20" stroke="rgba(231, 229, 228, 0.4)" strokeWidth="1" />
                    <line x1="50" y1="70" x2="650" y2="70" stroke="rgba(231, 229, 228, 0.4)" strokeWidth="1" />
                    <line x1="50" y1="120" x2="650" y2="120" stroke="rgba(231, 229, 228, 0.4)" strokeWidth="1" />
                    <line x1="50" y1="170" x2="650" y2="170" stroke="rgba(231, 229, 228, 0.6)" strokeWidth="1" />
                          ...
                          {points.map((p, i) => (
                            <g key={i} className="group cursor-pointer">
                              ...
                              <text
                                ...
                                y={p.y - 10}
                                textAnchor="middle"
                                className="text-[9px] font-bold fill-stone-900"
                              >
                                {activeChartMetric === 'sales'
              ...
              <div className="bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm space-y-4">
                <div className="text-right rtl:text-right ltr:text-left border-b border-stone-100 pb-4">
                  <h3 className="text-xs font-bold text-stone-900">
                  ...
                  >
                    <defs>
                      <linearGradient id="chartGrad30" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0%" stopColor="#44403C" stopOpacity="0.12" />
                        <stop offset="100%" stopColor="#44403C" stopOpacity="0.0" />
                      </linearGradient>
                    </defs>

                    <line x1="30" y1="20" x2="670" y2="20" stroke="rgba(231, 229, 228, 0.4)" strokeWidth="1" />
                    <line x1="30" y1="70" x2="670" y2="70" stroke="rgba(231, 229, 228, 0.4)" strokeWidth="1" />
                    <line x1="30" y1="120" x2="670" y2="120" stroke="rgba(231, 229, 228, 0.4)" strokeWidth="1" />
                    <line x1="30" y1="170" x2="670" y2="170" stroke="rgba(231, 229, 228, 0.6)" strokeWidth="1" />
                          ...
                          {points.map((p, i) => {
                            ...
                            return (
                              <g key={i} className="group">
                                <circle cx={p.x} cy={p.y} r="2.5" fill="#44403C" />
                                <text
                                  x={p.x}
                                  y={p.y - 8}
                                  textAnchor="middle"
                                ...
                                <text
                                  ...
                                  y="188"
                                  textAnchor="middle"
                                  className="text-[8px] font-bold fill-stone-400"
                                >
                                  {p.label}
                                </text>
                              </g>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Popular Drinks */}
              <div className="bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm space-y-4">
                <h3 className="text-xs font-bold text-stone-900 flex items-center gap-2 border-b border-stone-100 pb-3">
                  <Coffee className="h-4.5 w-4.5 text-stone-850" />
                  <span>
                ...
                {popularDrinksList.length === 0 ? (
                  <p className="text-xs text-stone-400 font-semibold text-center py-12">
                  ...
                  <div className="space-y-2">
                    {popularDrinksList.slice(0, 4).map((item, idx) => (
                      <div
                        key={idx}
                        className="flex items-center justify-between text-xs py-2 border-b border-stone-100 last:border-b-0"
                      >
                        <div className="flex items-center gap-2">
                          <span className="w-5 h-5 rounded bg-stone-100 text-stone-800 flex items-center justify-center font-bold text-[9px]">
                            {idx + 1}
                          </span>
                        ...
                        <span className="text-[10px] bg-stone-50 text-stone-700 font-bold px-2 py-0.5 rounded border border-stone-200/40">
                ...
                {popularMoodsList.length === 0 ? (
                  ...
                  <div className="space-y-2">
                    {popularMoodsList.slice(0, 4).map((item, idx) => (
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <span className="w-5 h-5 rounded bg-rose-50 text-rose-700 flex items-center justify-center font-bold text-[9px]">
                            {idx + 1}
                          </span>
                          <span className="font-semibold text-stone-900">
                            {item.name}
                        ...
                        <span className="text-[10px] bg-rose-50/50 text-rose-700 font-bold px-2 py-0.5 rounded border border-rose-200/20">
              ...
              <div className="bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm flex flex-col justify-between h-fit min-h-[180px]">
                <div className="space-y-2 text-right rtl:text-right ltr:text-left">
                  ...
                  <h3 className="text-xs font-bold text-stone-900 border-b border-stone-100 pb-3">
                ...
                <p className="text-[9.5px] text-stone-450 font-medium leading-relaxed pt-2 border-t border-stone-100">
                  {isAr
        ...
        (!limits.hasBetaAnalytics ? (
          ...
          <div className="space-y-8 animate-in fade-in duration-250">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm flex flex-col justify-between hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 h-36">
                <div className="flex justify-between items-start">
                  <div className="space-y-1 text-right rtl:text-right ltr:text-left">
                    <span className="text-[10px] font-bold text-stone-400 uppercase tracking-wider block">
                      {isAr ? 'عدد مرات فتح الكشك' : 'Kiosk Opens'}
                    </span>
                    <h3 className="text-xl sm:text-2xl font-bold text-stone-900 leading-none">
                      {totalOpens}
                    </h3>
                  </div>
                  <div className="p-2.5 rounded-xl bg-amber-50 text-amber-700 border border-amber-200/40 flex items-center justify-center">
                    <QrCode className="h-4.5 w-4.5" />
                  </div>
                </div>
                <div className="flex justify-between items-center pt-2.5 border-t border-stone-100 mt-auto text-[9.5px]">
              ...
              <div className="bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm flex flex-col justify-between hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 h-36">
                <div className="flex justify-between items-start">
                  ...
                  <div className="p-2.5 rounded-xl bg-purple-50 text-purple-700 border border-purple-200/40 flex items-center justify-center">
                    <Sparkles className="h-4.5 w-4.5" />
                  </div>
                </div>
                <div className="flex justify-between items-center pt-2.5 border-t border-stone-100 mt-auto text-[9.5px]">
              ...
              <div className="bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm flex flex-col justify-between hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 h-36">
                <div className="flex justify-between items-start">
                  ...
                  <div className="p-2.5 rounded-xl bg-blue-50 text-blue-700 border border-blue-200/40 flex items-center justify-center">
              ...
              <div className="bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm flex flex-col justify-between hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 h-36">
                <div className="flex justify-between items-start">
                  <div className="space-y-1 text-right rtl:text-right ltr:text-left">
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold text-emerald-800 leading-none">
                      %{betaConversionRate}
                    </h3>
                  </div>
                  <div className="p-2.5 rounded-xl bg-emerald-50 text-emerald-700 border border-emerald-200/40 flex items-center justify-center">
                    <TrendingUp className="h-4.5 w-4.5" />
                  </div>
                </div>
                <div className="flex justify-between items-center pt-2.5 border-t border-stone-100 mt-auto text-[9.5px]">
            ...
            <div className="bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm space-y-6">
              <div className="text-right rtl:text-right ltr:text-left space-y-1">
                ...
                <p className="text-[10px] text-stone-450 font-semibold">
                  {isAr
                ...
                {[
                  ...
                  return (
                    <div key={idx} className="space-y-2">
                      {idx > 0 && (
                        <div className="flex justify-between items-center text-[10px] text-stone-400 font-bold px-4">
                          <span>
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 p-3 bg-stone-50 rounded-xl border border-stone-200/80 relative overflow-hidden">
                        <div className="absolute inset-0 bg-stone-900/2 opacity-3 pointer-events-none" />
                        ...
                        <div className="flex items-center gap-3 w-full sm:w-1/2 z-10">
                          ...
                          <span className="text-xs font-bold text-stone-900 whitespace-nowrap min-w-[40px]">
                            {step.percent}%
                          </span>
                        </div>
                      </div>
        ...
        (!limits.hasBetaAnalytics ? (
          ...
          <div className="space-y-8 animate-in fade-in duration-250">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              ...
              <div className="lg:col-span-5 bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm flex flex-col justify-between space-y-6">
                ...
                <div className="flex flex-col items-center justify-center py-6 bg-stone-50 rounded-2xl border border-stone-200/60 relative">
                  <span className="text-5xl font-bold text-stone-900">
                    %{betaFeedbackRate}
                  </span>
                  <span className="text-[10px] font-bold text-stone-400 mt-2 uppercase tracking-wider">
                    {isAr ? 'معدل الرضا العام' : 'Overall Satisfaction Rate'}
                  </span>

                  <div className="flex gap-6 mt-6 w-full px-6">
                    <div className="flex-1 text-center bg-white p-3 rounded-xl border border-stone-200">
                      <span className="text-xl">👍</span>
                      <h4 className="text-xs font-bold text-emerald-700 mt-1">
                    ...
                    <div className="flex-1 text-center bg-white p-3 rounded-xl border border-stone-200">
                      <span className="text-xl">👎</span>
                      <h4 className="text-xs font-bold text-rose-700 mt-1">
                ...
                <p className="text-[9.5px] text-stone-450 font-medium leading-relaxed">
                  {isAr
              ...
              <div className="lg:col-span-7 bg-white p-5 rounded-2xl border border-stone-200/80 shadow-sm space-y-4">
                <div className="space-y-1">
                  <h3 className="text-sm font-bold text-stone-900">
                    {isAr
                ...
                <div className="divide-y divide-stone-100 max-h-[360px] overflow-y-auto pr-1 scrollbar-none">
                  {(() => {
                    const counts: Record<
                      string,
                      ...
                      return (
                        ...
                        >
                          <div className="flex-1">
                            ...
                            <span className="text-[9.5px] text-stone-400 font-semibold block mt-0.5">
                              {isAr
                          ...
                          <div className="flex items-center gap-4">
                            <div className="text-right">
                              ...
                              <span className="text-[9px] text-stone-400 font-semibold block">
                                {isAr ? 'دقة المطابقة' : 'Accuracy'}
                              </span>
                            </div>
                            <div className="flex gap-2 text-[10px] font-bold">
                              <span className="text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-100/30">
                                👍 {item.positive}
                              </span>
                              <span className="text-rose-700 bg-rose-50 px-2 py-0.5 rounded-full border border-rose-100/30">
                                👎 {item.negative}
                              </span>
                            </div>
                          </div>
